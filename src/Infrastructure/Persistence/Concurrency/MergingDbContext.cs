...
namespace Nexus.Infrastructure.Persistence.Concurrency;
public abstract class MergingDbContext : DbContext
{
    ...
    private Task StepBackBeforeRetry(CancellationToken cancellationToken)
    {
        return Task.Delay(Random.Next(1, 20), cancellationToken);
    }
